...
setwd("C:\\Users\\veron\\Dropbox (Harvard)\\smartsurfaces\\phoenix_policecalls")
...
# load in derived datasets (from 1_prep rds file)
...
# round(pred_tmax$allRRfit[which(names(pred_tmax$allRRfit) == "30.6")],2)
# round(pred_tmax$allRRlow[which(names(pred_tmax$allRRlow) == "30.6")],2)
# round(pred_tmax$allRRhigh[which(names(pred_tmax$allRRhigh) == "30.6")],2)
# pred_tmax <- crosspred(cb.tmax.obs, mod_tmax, cen=30.6, by=0.1)
# round(pred_tmax$allRRfit[which(names(pred_tmax$allRRfit) == "41.6")],2)
# round(pred_tmax$allRRlow[which(names(pred_tmax$allRRlow) == "41.6")],2)
# round(pred_tmax$allRRhigh[which(names(pred_tmax$allRRhigh) == "41.6")],2)
# pred_tmin <- crosspred(cb.tmin.obs, mod_tmin, cen=5.9, by=0.1)
# round(pred_tmin$allRRfit[which(names(pred_tmin$allRRfit) == "16.3")],2)
# round(pred_tmin$allRRlow[which(names(pred_tmin$allRRlow) == "16.3")],2)
# round(pred_tmin$allRRhigh[which(names(pred_tmin$allRRhigh) == "16.3")],2)
# pred_tmin <- crosspred(cb.tmin.obs, mod_tmin, cen=16.3, by=0.1)
# round(pred_tmin$allRRfit[which(names(pred_tmin$allRRfit) == "28.7")],2)
# round(pred_tmin$allRRlow[which(names(pred_tmin$allRRlow) == "28.7")],2)
# round(pred_tmin$allRRhigh[which(names(pred_tmin$allRRhigh) == "28.7")],2)
# 

## get cumulative associations (50th to 90th percentile)
# pred_himax <- crosspred(cb.himax.obs, mod_himax, cen=18.4, by=0.2)
# round(pred_himax$allRRfit[which(names(pred_himax$allRRfit) == "30.6")],2)
# round(pred_himax$allRRlow[which(names(pred_himax$allRRlow) == "30.6")],2)
# round(pred_himax$allRRhigh[which(names(pred_himax$allRRhigh) == "30.6")],2)
# pred_himax <- crosspred(cb.himax.obs, mod_himax, cen=30.6, by=0.1)
# round(pred_himax$allRRfit[which(names(pred_himax$allRRfit) == "41.6")],2)
# round(pred_himax$allRRlow[which(names(pred_himax$allRRlow) == "41.6")],2)
# round(pred_himax$allRRhigh[which(names(pred_himax$allRRhigh) == "41.6")],2)
# pred_himin <- crosspred(cb.himin.obs, mod_himin, cen=5.9, by=0.1)
# round(pred_himin$allRRfit[which(names(pred_himin$allRRfit) == "16.3")],2)
# round(pred_himin$allRRlow[which(names(pred_himin$allRRlow) == "16.3")],2)
# round(pred_himin$allRRhigh[which(names(pred_himin$allRRhigh) == "16.3")],2)
# pred_himin <- crosspred(cb.himin.obs, mod_himin, cen=16.3, by=0.1)
# round(pred_himin$allRRfit[which(names(pred_himin$allRRfit) == "28.7")],2)
# round(pred_himin$allRRlow[which(names(pred_himin$allRRlow) == "28.7")],2)
# round(pred_himin$allRRhigh[which(names(pred_himin$allRRhigh) == "28.7")],2)
...
res_lag <- res %>% filter(lag %in% c("lag0", "lag1")) %>% mutate(type="Overall")
...
## get cumulative associations (10th to 50th percentile)
# pred_tmax <- crosspred(cb.tmax.obs, mod_tmax, cen=18.4, by=0.2)
# round(pred_tmax$allfit[which(names(pred_tmax$allfit) == "30.6")],0)
# round(pred_tmax$alllow[which(names(pred_tmax$alllow) == "30.6")],0)
# round(pred_tmax$allhigh[which(names(pred_tmax$allhigh) == "30.6")],0)
# pred_tmax <- crosspred(cb.tmax.obs, mod_tmax, cen=30.6, by=0.1)
# round(pred_tmax$allfit[which(names(pred_tmax$allfit) == "41.6")],0)
# round(pred_tmax$alllow[which(names(pred_tmax$alllow) == "41.6")],0)
# round(pred_tmax$allhigh[which(names(pred_tmax$allhigh) == "41.6")],0)
# pred_tmin <- crosspred(cb.tmin.obs, mod_tmin, cen=5.9, by=0.1)
# round(pred_tmin$allfit[which(names(pred_tmin$allfit) == "16.3")],0)
# round(pred_tmin$alllow[which(names(pred_tmin$alllow) == "16.3")],0)
# round(pred_tmin$allhigh[which(names(pred_tmin$allhigh) == "16.3")],0)
# pred_tmin <- crosspred(cb.tmin.obs, mod_tmin, cen=16.3, by=0.1)
# round(pred_tmin$allfit[which(names(pred_tmin$allfit) == "28.7")],0)
# round(pred_tmin$alllow[which(names(pred_tmin$alllow) == "28.7")],0)
# round(pred_tmin$allhigh[which(names(pred_tmin$allhigh) == "28.7")],0)
# 
# 
## get cumulative associations (50th to 90th percentile)
# pred_himax <- crosspred(cb.himax.obs, mod_himax, cen=18.4, by=0.2)
# round(pred_himax$allfit[which(names(pred_himax$allfit) == "30.6")],0)
# round(pred_himax$alllow[which(names(pred_himax$alllow) == "30.6")],0)
# round(pred_himax$allhigh[which(names(pred_himax$allhigh) == "30.6")],0)
# pred_himax <- crosspred(cb.himax.obs, mod_himax, cen=30.6, by=0.1)
# round(pred_himax$allfit[which(names(pred_himax$allfit) == "41.6")],0)
# round(pred_himax$alllow[which(names(pred_himax$alllow) == "41.6")],0)
# round(pred_himax$allhigh[which(names(pred_himax$allhigh) == "41.6")],0)
# pred_himin <- crosspred(cb.himin.obs, mod_himin, cen=5.9, by=0.1)
# round(pred_himin$allfit[which(names(pred_himin$allfit) == "16.3")],0)
# round(pred_himin$alllow[which(names(pred_himin$alllow) == "16.3")],0)
# round(pred_himin$allhigh[which(names(pred_himin$allhigh) == "16.3")],0)
# pred_himin <- crosspred(cb.himin.obs, mod_himin, cen=16.3, by=0.1)
# round(pred_himin$allfit[which(names(pred_himin$allfit) == "28.7")],0)
# round(pred_himin$alllow[which(names(pred_himin$alllow) == "28.7")],0)
# round(pred_himin$allhigh[which(names(pred_himin$allhigh) == "28.7")],0)
...
# save subplot into new folder named 'parts' to be combined later for supplemental figures
saveRDS(p_type, paste("C:\\Users\\veron\\Dropbox (Harvard)\\smartsurfaces\\phoenix_policecalls\\parts\\", this, "_cd.rds",sep = ""))

# specific lags
# save subplot into new folder named 'main' to be combined later for main figure 2
res_lag <- res %>% mutate(avg=mean(dat$n)) %>% filter(lag %in% c("lag0", "lag1")) %>% mutate(type="Overall")
